...
class BrokerConnConfig(DataClassBase):
    ...
    SQLACHEMY_ENGINE_URL = 'mysql+pymysql://root:123456@127.0.0.1:3306/testdb2?charset=utf8'
    ...
    # CELERY_BROKER_URL = 'confluentkafka://192.168.1.105:9092'  # 使用celery作为中间件。funboost新增支持celery框架来运行函数
